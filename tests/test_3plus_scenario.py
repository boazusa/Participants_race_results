...
class Test3PlusEventScenario:
    ...
    def test_age_filtering_logic(self, race_analyzer, mock_participants_df, birth_years):
        ...
        expected_birth_years = [1980, 1985, 1978]  # Within 40-49 age range (assuming current year is 2025)
    ...
    def test_race_keyword_filtering(self, race_analyzer, mock_participants_df, scenario_params):
    ...
    def test_combined_filtering(self, race_analyzer, mock_participants_df, birth_years, scenario_params):
    ...
    def test_get_filtered_names_integration(self, race_analyzer, mock_participants_df, birth_years, scenario_params):
