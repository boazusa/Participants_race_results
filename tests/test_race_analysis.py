...
class TestRaceAnalyzerInitialization:
    ...
    def test_init_with_all_parameters(self):
        ...
        assert (
            analyzer.url == "https://regi.3plus.co.il/events/page/test"
        )  # view-source removed
...
class TestNormalizeYear:
    ...
    def test_normalize_year_edge_cases(self):
        ...
        assert (
            best_race_results_per_participant.normalize_year("15//1980") == 1980
        )  # Empty part is ignored
...
class TestWebScraping:
    ...
    def test_scrape_3plus_participants_table_success(self):
        ...
        with patch("requests.get", return_value=mock_response):
            analyzer = best_race_results_per_participant(
                "https://regi.3plus.co.il/events/page/test", race_name="Test"
            )
    ...
    def test_scrape_realtiming_participants_table_success(self):
        ...
        with patch("requests.get", return_value=mock_response):
            analyzer = best_race_results_per_participant(
                "https://realtiming.co.il/events/test", race_name="RealTiming Test"
            )
    ...
    def test_scrape_realtiming_participants_table_no_table(self):
        ...
        with patch("requests.get", return_value=mock_response):
            analyzer = best_race_results_per_participant(
                "https://realtiming.co.il/events/test", race_name="Test"
            )
...
class TestFiltering:
    ...
    def test_empty_dataframe_filtering(self):
        ...
        filtered_names = analyzer.get_filtered_names(
            min_year=1980, max_year=1990, gender="male", race_keyword="10"
        )
