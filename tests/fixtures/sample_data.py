...
class SampleDataGenerator:
    ...
    HEBREW_FIRST_NAMES = {
        'male': ['דני', 'משה', 'יוסי', 'דוד', 'שמעון', 'אברהם', 'יצחק', 'יעקב', 'יוסף', 'אהרון',
                'אליעזר', 'ישראל', 'מאיר', 'יהודה', 'לוי', 'בנימין', 'שלמה', 'שמואל', 'נתן', 'דוד'],
        'female': ['שרה', 'רחל', 'לאה', 'רבקה', 'מרים', 'דבורה', 'אסתר', 'יעל', 'תמר', 'נועה',
                  'מיכל', 'אביגיל', 'חנה', 'גילה', 'עדי', 'ליאת', 'אורלי', 'קרן', 'שירה', 'רות']
    }
    
    HEBREW_LAST_NAMES = ['כהן', 'לוי', 'ישראלי', 'בן דוד', 'פרץ', 'מזרחי', 'גולן', 'שמיר', 'ברק', 'פרץ',
                        'אברהם', 'יצחק', 'יעקב', 'יוסף', 'לוי', 'כהן', 'שמעוני', 'דוד', 'שלמה', 'שמואל',
                        'מרדכי', 'אהרוני', 'אליעזר', 'ישראל', 'מאיר', 'יהודה', 'בנימין', 'שלמה', 'שמואל', 'נתן']
    
    RACE_CATEGORIES = {
        '5K': ['5 ק"מ', '5ק"מ', '5000', '5 km', '5 קמ'],
        '10K': ['10 ק"מ', '10ק"מ', '10000', '9800', '10 km', '10 קמ'],
        '15K': ['15 ק"מ', '15ק"מ', '15000', '15 km', '15 קמ'],
        '21K': ['21 ק"מ', '21ק"מ', '21097', '21000', 'חצי מרתון', 'חצי מרתון תחרותי', 'חצי-מרתון'],
        '42K': ['42 ק"מ', '42ק"מ', '42195', 'מרתון', 'מרתון תחרותי', '42.195 ק"מ']
    }
    
    TEAMS = ['מכבי תל אביב', 'הפועל ירושלים', 'בית"ר תל אביב', 'מכבי חיפה', 'הפועל תל אביב',
             'מכבי פתח תקווה', 'הפועל פתח תקווה', 'בני יהודה', 'הפועל חיפה', 'מכבי נתניה',
             'מכבי ראשון לציון', 'הפועל ראשון לציון', 'בית"ר ירושלים', 'הפועל כפר סבא', 'מכבי כפר סבא']
    
    LOCATIONS = ['תל אביב', 'ירושלים', 'חיפה', 'באר שבע', 'פתח תקווה', 'ראשון לציון', 'נתניה',
                 'חולון', 'בני ברק', 'רמת גן', 'אשדוד', 'רחובות', 'בת ים', 'כפר סבא', 'הרצליה',
                 'מודיעין', 'רעננה', 'גבעתיים', 'קריית אונו', 'חדרה']
    
    @classmethod
    def generate_participants(cls, count=10, age_range=(20, 60), gender_ratio=0.6, seed=None):
    ...
    @classmethod
    def generate_race_results(cls, participants_df, num_results_per_person=3, seed=None):
    ...
    def normalize_distance(distance_str):
        ...
        if s in ["10 ק\"מ", "10ק\"מ", "9800", "10000", "10 קמ"]:
            return "10K"
        elif s in ["21097", "21 ק\"מ", "21000", "21K", "21k", "חצי מרתון", "חצי מרתון תחרותי", "חצי-מרתון"]:
            return "21K"
    ...
    def generate_excel_data(cls, file_path, participants_count=50, seed=None):
        ...
        results_df = cls.generate_race_results(participants_df, num_results_per_person=3, seed=seed)
...
class EdgeCaseData:
    ...
    def get_malformed_names():
        ...
        return [
            {'שם פרטי': '', 'שם משפחה': 'כהן', 'שנת לידה': '1980', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
            {'שם פרטי': 'דני', 'שם משפחה': '', 'שנת לידה': '1980', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
            {'שם פרטי': None, 'שם משפחה': 'לוי', 'שנת לידה': '1975', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
            {'שם פרטי': '123', 'שם משפחה': 'כהן', 'שנת לידה': '1980', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
            {'שם פרטי': 'דני-danny', 'שם משפחה': 'כהן', 'שנת לידה': '1980', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
        ]
    ...
    def get_malformed_years():
        ...
        return [
            {'שם פרטי': 'דני', 'שם משפחה': 'כהן', 'שנת לידה': '', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
            {'שם פרטי': 'משה', 'שם משפחה': 'לוי', 'שנת לידה': 'abcd', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
            {'שם פרטי': 'יוסי', 'שם משפחה': 'ישראלי', 'שנת לידה': '1800', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
            {'שם פרטי': 'דוד', 'שם משפחה': 'בן דוד', 'שנת לידה': '2025', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
            {'שם פרטי': 'שמעון', 'שם משפחה': 'פרץ', 'שנת לידה': '15/10/1980', 'מגדר': 'male', 'מקצה': '10 ק"מ'},
        ]
    ...
    def get_malformed_genders():
        ...
        return [
            {'שם פרטי': 'דני', 'שם משפחה': 'כהן', 'שנת לידה': '1980', 'מגדר': '', 'מקצה': '10 ק"מ'},
            {'שם פרטי': 'משה', 'שם משפחה': 'לוי', 'שנת לידה': '1975', 'מגדר': 'unknown', 'מקצה': '10 ק"מ'},
            {'שם פרטי': 'יוסי', 'שם משפחה': 'ישראלי', 'שנת לידה': '1985', 'מגדר': None, 'מקצה': '10 ק"מ'},
            {'שם פרטי': 'שרה', 'שם משפחה': 'לוי', 'שנת לידה': '1982', 'מגדר': 'other', 'מקצה': '10 ק"מ'},
        ]
    ...
    def get_malformed_races():
        ...
        return [
            {'שם פרטי': 'דני', 'שם משפחה': 'כהן', 'שנת לידה': '1980', 'מגדר': 'male', 'מקצה': ''},
            {'שם פרטי': 'משה', 'שם משפחה': 'לוי', 'שנת לידה': '1975', 'מגדר': 'male', 'מקצה': 'unknown'},
            {'שם פרטי': 'יוסי', 'שם משפחה': 'ישראלי', 'שנת לידה': '1985', 'מגדר': 'male', 'מקצה': None},
            {'שם פרטי': 'דוד', 'שם משפחה': 'בן דוד', 'שנת לידה': '1990', 'מגדר': 'male', 'מקצה': '123'},
        ]
...
def create_test_excel_file(file_path, scenario='default'):
    ...
    results = SampleDataGenerator.generate_race_results(participants, num_results_per_person=2, seed=42)
